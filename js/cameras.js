...
const CAMS = {
  ...
  runwayLow:  { label: '跑道仰拍',   get: (t, s) => ({ pos: V3(31, 1.1, 352), look: V3(2, Math.max(9, s.alt * 0.4), s.z), fov: 27 }) },
  liftChase:  { label: '离地追踪',   get: (t, s) => ({ pos: V3(s.x - 62, planeY(s) + 6, s.z + 78), look: V3(s.x, planeY(s) + 4, s.z), fov: 36 }) },
  gearWatch:  { label: '起落架观察', get: (t, s) => ({ pos: V3(s.x - 27, planeY(s) - 3, s.z + 36), look: V3(s.x, planeY(s) + 5, s.z - 4), fov: 40 }) },
  ...
  farewell:   { label: '云上远眺',   get: (t, s) => ({ pos: V3(s.x - 200, planeY(s) + 40, s.z - 160), look: V3(s.x, planeY(s) + 18, s.z), fov: 28 }) },
  // ---- 手动机位 ----
